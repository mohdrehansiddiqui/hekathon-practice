...
// import { getStorage, ref, getDownloadURL, uploadBytes, uploadString } from "https://www.gstatic.com/firebasejs/9.23.0/firebase-storage.js"; 
...
// // savePost.addEventListener('change',()=>{
// //   const file = postImage.files[0]; // Get the selected file from the input field
...
// //       // You can handle the file upload success here
// //     }).catch((error) => {
// //       console.error('File upload failed:', error);
// //       // You can handle the file upload error here
// //     });
// //   } else {
